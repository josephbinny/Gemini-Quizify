    ...
    if 'question_bank' not in st.session_state or len(st.session_state['question_bank']) == 0:
        ...
        with screen.container():
            ...
            with st.form("Load Data to Chroma"):
                ...
                ##### YOUR CODE HERE #####
                topic_input = st.text_input("Topic for Generative Quiz", placeholder="Enter the topic of the document. Leave blank for general questions")
                ...
                if submitted:
                    ...
                    if not topic_input: topic_input = "General Knowledge"
    ...
    if st.session_state.get("display_quiz", False):
        with st.container():
            ...
            with st.form("MCQ"):
                ...
                if not answer and answer_choice:
                    st.warning("Please pick an answer before submitting.")
